      ...
      <div className='items-center space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0'>
        <div className='flex flex-col items-center pt-8'>
          ...
          <div className='flex space-x-5 pt-6'>
            <a href='https://github.com/buckethead11' target="_blank">
            <svg
            ...
            <a href='https://www.linkedin.com/in/arjun-anand-pramod/' target="_blank">
            <svg
              viewBox="0 0 1024 1024"
              fill="currentColor"
              className='w-8 h-8 text-sky-500 hover:text-sky-600'
            >
              ...
              <a href='mailto:arjun018@e.ntu.edu.sg' target="_blank">
            <svg
              viewBox="0 0 1024 1024"
              fill="currentColor"
              className='w-8 h-8 text-sky-500 hover:text-sky-600'
